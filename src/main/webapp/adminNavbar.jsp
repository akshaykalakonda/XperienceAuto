			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="user-dropdown"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown"> <i class="fa fa-database"></i>&nbspDATA
					</a>
						<ul class="dropdown-menu">
							<li><a href="adminViewAllCus">CUSTOMERS</a></li>
							<li><a href="adminViewAllSell">SELLERS</a></li>
						</ul></li>
					<li class="user-dropdown"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown"> <i class="fa fa-check-circle"></i>&nbspREQUESTS
					</a>
						<ul class="dropdown-menu">
							<li><a href="adminCusReq">CUSTOMERS</a></li>
							<li><a href="adminSelReq">SELLERS</a></li>
						</ul></li>
					<li><a href="adminviewproducts"><i class="fas fa-cogs"></i>&nbspPRODUCTS</a></li>
					<li class="user-dropdown"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown"> <i class="fas fa-user-circle"></i>&nbsp&nbsp${aname}
					</a>
						<ul class="dropdown-menu">
