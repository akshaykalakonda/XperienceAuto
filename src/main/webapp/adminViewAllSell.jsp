		...
		<c:forEach items="${sdata}" var="sel">
			<div class="data-card"
				...
				<div class="buttons">
					...
					</a> <a href='<c:url value="${sel.sacceptence}"></c:url>'>
						<button style="background-color: green;">
							<c:if test="${sel.sacceptence=='true'}">
							&#10003; <b>Accepted</b>
							</c:if>
						</button>
					</a> <a href='<c:url value="selview?id=${sel.id}"></c:url>'>
						<button style="background-color: blue;">
							<i class="fas fa-eye"></i> <b>View</b>
						</button>
					</a> <a href='<c:url value="seldelete?id=${sel.id}"></c:url>'>
						<button>
