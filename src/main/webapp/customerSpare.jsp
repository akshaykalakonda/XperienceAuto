...
<body>
	...
	<h2 style="text-align: center;">Available Automobile Products</h2>
	...
	<div id="product-list">
		...
		<c:forEach items="${pdata}" var="p">
			<div class="product">
				...
				<button id="scroll-to-cart" onclick="scrollToCart()">Go to
					Cart</button>
			</div>
		</c:forEach>
	...
	<div id="shopping-cart">
		...
		<span class="blink_text">
			<div id="empty-cart-message"
				style="display: none; text-align: center; font-size: larger; color: #FF5733; animation: blink 1s infinite;">
		...
		<table id="cart-items">
			...
			<tfoot>
				<tr>
					...
					<td id="total-amount" colspan="2">0.00</td>
		...
		<div id="shopping-cart">
			...
			<button class="btn-custom" onclick="pay()">Pay Now</button>
        ...
        function pay(amt) {
            var options = {
                ...
                "handler": function (response) {
                    var paymentId = response.razorpay_payment_id;  // get the payment ID from the response object
                    window.location.href = "paymentsucessful?payment_id=" + paymentId;
                },
                "prefill": {
                    "name": "",
                    "email": "",
